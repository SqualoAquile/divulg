...
<script type="text/javascript">
    var baselink = '<?php echo BASE_URL;?>',
        ...
        info_vendedor = <?php echo json_encode($vendedor) ?>
</script>
...
<!-- Este javaScript serve para fazer verificações inerentes à cada módulo -->
...
<section class="mb-5">
    <form id="form-principal" method="POST" class="needs-validation" autocomplete="off" novalidate>
        ...
        <button id="main-form" class="d-none"
            data-diasantesadd = "<?php echo $parametros['dias_antes_adicao']?>"
            data-horalimiteadd = "<?php echo $parametros['hora_limite_adicao']?>"
            data-diasantesedt = "<?php echo $parametros['dias_antes_edicao']?>"
            data-horalimiteedt = "<?php echo $parametros['hora_limite_edicao']?>">
        </button>

        <?php if($table) include "_pedidos_form2.php" ?>
    </form>
